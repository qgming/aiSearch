  ...
  methods: {
    ...
    async getCollectList() {
      const initialList = [
        ...
        { id: 5, title: '今日热榜', url: 'https://rebang.today', logo: 'https://api.iowen.cn/favicon/rebang.today.png' },
        { id: 6, title: '智能体', url: 'https://www.jdwdai.com', logo: 'https://api.iowen.cn/favicon/www.jdwdai.com.png' },
      ];
